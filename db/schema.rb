...
ActiveRecord::Schema.define(version: 2020_12_18_025333) do
  ...
  create_table "comment_has_replies", force: :cascade do |t|
    t.bigint "reply_id", null: false
    t.bigint "comment_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id"], name: "index_comment_has_replies_on_comment_id"
    t.index ["reply_id"], name: "index_comment_has_replies_on_reply_id"
  end
  ...
  add_foreign_key "comment_has_replies", "comments"
